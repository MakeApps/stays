 ...
 * Full condo page.
 *
 * Not in the approved design — that has only the quick-view drawer — so this is
 * built from the same DS vocabulary. The financial panels are a client island,
 * so the page's static chrome streams immediately and only the rollup waits.
 */
